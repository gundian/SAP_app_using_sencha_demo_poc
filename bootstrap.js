...
Ext.Loader.addClassPathMappings({
  "Ext": "../../../src",
  "Ext.data.proxy.OData": "app/model/OData.js",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "test.controller.Account": [],
  "test.controller.SalesControl": [],
  "test.model.BusinessPartner": [],
  "test.model.ChartModel": [],
  "test.model.MaterialMaster": [],
  "test.model.SalesHeader": [],
  "test.model.SalesItem": [],
  "test.model.SalesOrder": [],
  "test.store.BusinessPartners": [],
  "test.store.ChartStore": [],
  "test.store.MaterialMasters": [],
  "test.store.SalesHeaders": [],
  "test.store.SalesItems": [],
  "test.store.SalesOrders": [],
  "test.view.BusinessPartner": [],
  "test.view.ByBusinessPartner": [],
  "test.view.GraphCar": [],
  "test.view.LoginForm": [],
  "test.view.Main": [],
  "test.view.MainView": [],
  "test.view.MaterialMaster": [],
  "test.view.MyBarChart": [],
  "test.view.RegisterForm": [],
  "test.view.SalesDetail": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "test.view.BusinessPartner": [
    "widget.businesspartner"
  ],
  "test.view.ByBusinessPartner": [
    "widget.bybusinesspartner"
  ],
  "test.view.GraphCar": [
    "widget.graphcar"
  ],
  ...
  "test.view.SalesItemDetail": [
    "widget.salesitemdetail"
  ],
  "test.view.SalesOrderItemList": [
    "widget.salesorderitemlist"
  ],
  "test.view.SalesOrderView": [
    "widget.salesorderview"
  ],
  "test.view.SalesOrders": [
    "widget.salesorders"
  ]
